        ...
        <nav class="navigation__nav">
            <ul class="navigation__list">
                ...
                <li class="navigation__item" id="dropdown">
                    <a href="hosting"  class="navigation__link"><span style="transform:rotate(90deg);">&rsaquo;</span> خرید هاست</a>
                        <div class="navigation__link--dropdown">
                            <ul>
                                <li><a href="hosting/linux_hosting">هاست لینوکس</a></li>
                                <li><a href="hosting/wordpress_hosting">هاست وردپرس</a></li>
                                <!-- <li><a href="hosting/ecommerce_hosting">هاست فروشگاهی</a></li> -->
                            </ul>
                        </div>
                </li>
        ...
        <nav class="main-nav">
            <div class="container row">
                ...
                <ul class="main-nav__list">
                    <li class="main-nav__item"><a href="index.php" class="main-nav__link <?php if ($file_url == 'index') echo 'nav-active'; ?>">خانه</a></li>
                    <li class="main-nav__item dropdown">
                        <a href="hosting" class="main-nav__link">خرید هاست</a>
                        <div class="main-nav__link--dropdown">
                            <ul>
                                <li><a href="hosting/linux_hosting">هاست لینوکس</a></li>
                                <li><a href="hosting/wordpress_hosting">هاست وردپرس</a></li>
                    ...
                    <li class="main-nav__item"><a href="contact" class="main-nav__link <?php if ($file_url == 'contact') echo 'nav-active'; ?>">تماس با ما</a></li>
                </ul>
